...
public class ElasticSearchService {
    ...
    public void createIndex(String idxName, String idxSQL) {
        ...
        try {
            ...
            request.mapping(idxName, idxSQL, XContentType.JSON);
            buildSetting(request);
            log.info("size={}", restHighLevelClient.getLowLevelClient().getNodes().get(0));
     ...
     * @since
     */
    public void insertBatch(String idxName, List<Map> list) {
        BulkRequest request = new BulkRequest();
        list.forEach(item -> request.add(new IndexRequest(idxName).id(MapUtils.getString(item, "id"))
